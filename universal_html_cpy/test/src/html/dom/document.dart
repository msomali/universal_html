...
void _testDocument() {
  group('Document:', () {
    final document = universal_html_cpy.document;
    test('initial state', () {
  ...
  group('HtmlDocument', () {
    test('head', () {
      expect(universal_html_cpy.document.head, isNotNull);
    });

    test('body', () {
      expect(universal_html_cpy.document.body, isNotNull);
    });

    test('onVisibilityChange', () {
      final htmlDocument = universal_html_cpy.document;
